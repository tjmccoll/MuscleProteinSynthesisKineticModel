function [t, x, x_conc, expData_conc, expData_mass, CostParameters, interventionDuration, plasmaVolume, ...
    skeletalMuscleVolume] = runModel_OIM_230926_signallingPermissive(Protocol, ExpDataFile, SubjectData, ...
...
if isequal(Protocol, 'Calibration, young adults') 
    ...
    [t2,x2] = ode23s(@(t2,x2) modelDerivative_OIM_230922_signallingPermissive(t2, x2, KValueVector_given, OptimizeParameters, ...
        ab, KValueVector_factor, EqDur, GlucInfRate, LeuInfRate), ...
