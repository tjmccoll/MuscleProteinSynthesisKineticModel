function [CostIndividual, CostTotal] = plot_Figure_S3_230221(figNum, t, x_conc, x_mass, ExpData, ...
...
[Title, ~, ~, CostIndividual, CostTotal] = CostCalculation_230221(t, x_conc_update, AktS473_pos, p70S6KT389_pos, ...
    EquilibriumDuration, CostParameters(CostParameters~=45), ExpData, mps_integral_grams);
