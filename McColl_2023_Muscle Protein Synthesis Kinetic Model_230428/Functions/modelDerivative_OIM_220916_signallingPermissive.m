function [dx] = modelDerivative_OIM_220916_signallingPermissive(t, x, KValueVector_given, ...
    OptimizeParameters, OptimizeParameters_initial, KValueVector_factor, EquilibriumDuration, ...
    GlucoseInfRate, LeucineInfRate_given)
% System of ordinary differential equations that the ODE function solves.
% This 'signallingPermissve' system of ODEs removes the reactions for
% p70S6K and p-p70S6K such that both are maintained at their initial value
% input
%   [dx] = modelDerivative_OIM_220916_signallingPermissive(t, x, 
%       KValueVector_given, OptimizeParamters, OptimizeParameters_initial, 
%       KValueVector_factor, EquilibriumDuration, GlucoseInfRate,
...
r9 = KValue(9)*Protein / IR_beta_pY1146;
...
dx(25) = r38 + r43 - r39;
dx(26) = r39 - r38 - r43;
dx(27) = 0; %r42 - r40 - r41; % p70S6K maintained at initial value
dx(28) = 0; %r40 + r41 - r42; % p-p70S6K maintained at initial value
